const getState = ({ getStore, getActions, setStore }) => {
    return {
        ...
        actions: {
            createUser: () => {
                fetch("https://playground.4geeks.com/contact/agendas/moises", {
                    method: "POST",
            ...
            getInfoContacts: () => {
                fetch("https://playground.4geeks.com/contact/agendas/moises/contacts", {
                    method: "GET"
                })
                    .then((response) => {
            ...
            deleteContact: (id) => {
                fetch(`https://playground.4geeks.com/contact/agendas/moises/contacts/${id}`, {
                    method: "DELETE",
                })
                    .then((response) => {
